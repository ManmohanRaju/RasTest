...
@NgModule({
  ...
  declarations: [OstfManagePrgDashboardComponent, OstfManagePrgFinanceComponent, OstfManagePrgEmailTemplatesComponent, OstfManagePrgHeaderComponent, OstfManagePrgEmailTemplateDialog, OstfManagePrgParcelsComponent, OstfManagePrgParcelsDialog, OstfManagePrgUserMgtComponent, OstfManagePrgCountyUsersComponent,OstfManagePrgCountyUsersDialog, OstfManagePrgAgencyUsersComponent,OstfManagePrgAgencyUsersDialog, OstfManagePrgFundingDetailsComponent,OstfManagePrgSchedulingComponent],
  imports: [
  ...
  entryComponents: [OstfManagePrgEmailTemplatesComponent, OstfManagePrgEmailTemplateDialog, OstfManagePrgParcelsComponent, OstfManagePrgParcelsDialog, OstfManagePrgCountyUsersComponent, OstfManagePrgCountyUsersDialog, OstfManagePrgAgencyUsersComponent, OstfManagePrgAgencyUsersDialog],
})
